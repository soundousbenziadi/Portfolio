    ...
    <section id="contact" className="w-full px-6 py-10 md:py-20">
      ...
      <div className="mx-auto grid max-w-5xl grid-cols-1 gap-10 md:grid-cols-[0.85fr_1.15fr] md:gap-14">
          ...
          <div className="flex flex-col gap-3">
            {socialLinks.map((link) => (
              <a
                ...
                className="group flex items-center gap-4 rounded-tl-2xl rounded-br-2xl border border-foreground/10 bg-foreground/5 px-5 py-3.5 backdrop-blur-md transition-colors hover:bg-foreground/10"
              >
        ...
        <motion.div
          ...
          className="rounded-tl-2xl rounded-br-2xl border border-foreground/10 bg-foreground/5 p-6 backdrop-blur-md sm:p-8"
        >
          <ContactForm />
        </motion.div>
      </div>
